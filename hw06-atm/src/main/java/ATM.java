public class ATM {
    ...
    ATM() {
        cells = new Cells();
        cells.fillCells(Denomination.FIFTY,100);  //Fill in the cell with banknotes "50" in quantity 100 by a cash collector
        cells.fillCells(Denomination.HUNDRED,100);
        cells.fillCells(Denomination.TWOHUNDRED,100);
        cells.fillCells(Denomination.FIVEHUNDRED,100);
        cells.fillCells(Denomination.THOUSAND,100);
        cells.fillCells(Denomination.TWOTHOUSAND,100);
        cells.fillCells(Denomination.FIVETHOUSAND,100);
    ...
    static void showCells() {  //Display banknotes in ATM cells
        System.out.println("Count of FIFTY: " + cells.getCountFifty());
        System.out.println("Count of HUNDRED: " + cells.getCountHundred());
        System.out.println("Count of TWOHUNDRED: " + cells.getCountTwohundred());
        System.out.println("Count of FIVEHUNDRED: " + cells.getCountFivehundred());
        System.out.println("Count of THOUSAND: " + cells.getCountThousand());
        System.out.println("Count of TWOTHOUSAND: " + cells.getCountTwothousand());
        System.out.println("Count of FIVETHOUSAND: " + cells.getCountFivethousand());
    }
